...
Table \@ref(tab:clark) shows that, in this dataset, there is no one in the severe hearing loss categories and the large majority has normal hearing (`r data_clark[1, "nperc"]`). The median for all observation with normal hearing (\leq 25dB) is 6dB. We therefor suggest to trichotomize the data into the following categories:
