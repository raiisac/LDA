...
\left\{
                \begin{array}{ll}
                  logit[P(Y_i\leq Normal|x_i)] = \alpha_1 + \beta_{1}age_i +  \beta_{2}TIME_i + \beta_{3}learning_i + \\ \hspace{5cm} \beta_{4}age^2_i + \beta_{5}age_i*TIME_i \\
                  logit[P(Y_i\leq Hearing Loss|x_i)] = \alpha_2 + \beta_{1}age_i + \beta_{2}TIME_i + \beta_{3}learning_i + \\ \hspace{5cm} \beta_{4}age^2_i + \beta_{5}age_i*TIME_i 
                \end{array}
              \right.
(\#eq:Ordinal)
\end{equation}
