...
Intercept_df_var_mon<-mean(df_monotone$Intercept_var)+(81/80)*var(df_monotone$Intercept)
age_df_var_mon<-mean(df_monotone$age_var)+(81/80)*var(df_monotone$age)
TIME_discrete_df_var_mon<-mean(df_monotone$TIME_discrete_var)+(81/80)*var(df_monotone$TIME_discrete)
age_sqrd_df_var_mon<-mean(df_monotone$age_sqrd_var)+(81/80)*var(df_monotone$age_sqrd)
age_TIME_df_var_mon<-mean(df_monotone$age_TIME_var)+(81/80)*var(df_monotone$age_TIME)
learning_df_var_mon<-mean(df_monotone$learning_var)+(81/80)*var(df_monotone$learning_var)
...
Intercept_df_var_full<-mean(df_full$Intercept_var)+(81/80)*var(df_full$Intercept)
age_df_var_full<-mean(df_full$age_var)+(81/80)*var(df_full$age)
TIME_discrete_df_var_full<-mean(df_full$TIME_discrete_var)+(81/80)*var(df_full$TIME_discrete)
age_sqrd_df_var_full<-mean(df_full$age_sqrd_var)+(81/80)*var(df_full$age_sqrd)
age_TIME_df_var_full<-mean(df_full$age_TIME_var)+(81/80)*var(df_full$age_TIME)
learning_df_var_full<-mean(df_full$learning_var)+(81/80)*var(df_full$learning_var)
